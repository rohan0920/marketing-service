...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			<label for="address" class="control-label col-md-4">Phone Number</label>
			<div class="col-md-4">
				<input type="text" name="address" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="city" class="control-label col-md-4">Address</label>
			<div class="col-md-4">
				<input type="text" name="city" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="zip_code" class="control-label col-md-4">Referal Code</label>
			<div class="col-md-4">
	...
	<p class="lead">Thank You For Shopping.</p>
<?php
	} else {
